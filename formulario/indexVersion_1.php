<?php
    ...
    $animales= animalArrayv1();
    $comoConocio = conocerArrayv1();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <main>
        ...
        <section id="formulario">
            ...
            <form action="recibirGet.php" method="get">
                ...
                <?php
                    foreach($animales as $valorAnimales){
                        echo '<label>
                        <input type="checkbox" name="animales[]" value="'.$valorAnimales.'">'.$valorAnimales.'';
                    }
                ?>
                <!--Checkbox solo 1-->
                ...
                <?php
                    foreach($comoConocio as $valorComoConcio){
                        echo '<option value="'.$valorComoConcio.'">'.$valorComoConcio.'</option>';
                    }
                ?>
                </select>
                <!--Envicar y Resetear-->
