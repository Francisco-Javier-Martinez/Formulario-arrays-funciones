<?php
    ...
    $animalesPeligro=animalArrayv2();
    $conocio=conocerArrayv2();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <main>
        ...
        <section id="formulario">
            ...
            <form action="recibirGet.php" method="get">
                ...
                <?php foreach($animalesPeligro as $indiceAnimal =>$valorAnimal){
                    echo '<label> 
                            <input type="checkbox" name="animales[]" value="'.$indiceAnimal.'">'.$valorAnimal.'
                         </label>';
                }?>
                <!--Checkbox solo 1-->
                ...
                <select id="comoConocio" name="comoConocio">
                    <?php foreach($conocio as $indiceConocio => $valorConocio){
                        echo '<option value="'. $indiceConocio .'">'.$valorConocio.'';
                    }
                    ?>
                </select>
                <!--Envicar y Resetear-->
